          ...
          <div className='bg-white p-4 rounded w-30 border'>
            ...
            <form action='' onSubmit={cadastrar}>
                 <div className='mb-3'>      
                    ...
                    <input type='text' onKeyUp={Nome} placeholder='Entre com o nome:' value={nome} onChange={e => nomechange(e.target.value)} style={{fontSize:'20px', width:250, margin:'0 115px'}} className='form-control rounded-0' name='nome' id='nome'/>
                 </div>
                 <div className='mb-3'>
