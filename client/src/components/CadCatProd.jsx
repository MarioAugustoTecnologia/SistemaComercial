             ...
             <h4><center>Cadastrar Categoria:</center></h4><br /> 
              <form action='' onSubmit={cadastrar}>
                 <div className='mb-3'>      
                    ...
                    <input type='text' placeholder='Entre com o nome:' value={nome} onChange={e => nomechange(e.target.value)} onKeyUp={MostraNome} style={{fontSize:'20px', width:250, margin:'0 115px'}} className='form-control rounded-0' name='nome' id='nome'/>
                 </div>
                 <div className='mb-3'>
