    ...
    if (isValidate()) {
      ...
      Swal.fire({
        ...
        if (result.isConfirmed) {
          ...
          fetch("https://sistemacomercial-fv5g.onrender.com/catproduto", {
            method: "POST",
      ...
      <div className="container" style={{ display: 'flex', margin: '0 230px', marginTop: '-900px' }}>
        ...
        <form action='' onSubmit={cadastrar}>
          ...
          <div className='mb-3'>
            ...
            <input type='text' placeholder='Entre com o nome:' value={nome} onChange={e => nomechange(e.target.value)} onKeyUp={MostraNome} style={{ fontSize: '17px', width: 250, margin: '0 115px', fontWeight: 'bold', color: 'navy' }} className='form-control rounded-0' name='nome' id='nome' />
          </div>
          <div className='mb-3'>
            ...
            <Link to='/produtos' className="btn border rounded-0" style={{ color: 'white', backgroundColor: 'orange', margin: '0 -90px', fontSize: '15px', width: 100 }}>Voltar:</Link>
          </div>
          <ToastContainer />
        </form>
