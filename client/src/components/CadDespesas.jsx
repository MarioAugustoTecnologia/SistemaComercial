     ...
     <div className="container-fluid">
      ...
      <div className="container" style={{ display: 'flex', margin: '0 230px', marginTop: '-900px' }}>
        ...
        <form action='' onSubmit={cadastrar}>
           ...
           <h5><center><strong>Cadastrar Despesa:</strong></center></h5><br />
          ...
          <div className='mb-3'>
            ...
            <input type="decimal" onKeyUp={MostraCusto} id='custo' value={custo} onChange={e => custochange(e.target.value)} style={{ fontSize: '17px', width: 200, margin: '0 115px', fontWeight: 'bold', color: 'navy' }} placeholder='Entre com o custo:' className='form-control rounded-0' name='custo' />

          </div>

          <div className='mb-3'>
            <label htmlFor='datapagamento' style={{ fontSize: '17px', margin: '0 115px', fontWeight: 'bold' }}>Data de Pagamento:</label>
            <input type='date' value={datapag} onChange={e => datapagchange(e.target.value)} style={{ fontSize: '17px', width: 225, margin: '0 115px', fontWeight: 'bold', color: 'navy' }} className='form-control rounded-0' name='datapag' />
          </div>
          <div className='mb-3'>
            <label htmlFor='mes' style={{ fontSize: '17px', margin: '0 115px', fontWeight: 'bold' }}>Mês:</label>
            <select style={{ fontSize: '17px', width: 130, margin: '0 115px', marginTop: '0px', fontWeight: 'bold', color: 'navy' }} name='mes' id='mes' className='form-select' value={mes} onChange={e => meschange(e.target.value)}>
              <option value=""></option>
