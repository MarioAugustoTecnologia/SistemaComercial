        ...
        <div className="col p-0 m-0" style={{ fontFamily: 'arial' }} >
          ...
          <div className="px-5 mt-5">
            <div className="mb3">
              ...
              <input type="search" autoFocus='true' className="consultanome" value={buscadata} onChange={(e) => setBuscaData(e.target.value)} style={{ fontFamily: 'arial', fontSize: '22px', fontWeight:'bold', color:'navy'}} />
              <Link to="/compras" className="btn btn-success" style={{ fontSize: '18px', fontFamily: 'arial', width: '140px', margin: '0 20px' }}>Voltar:</Link>
              <Link onClick={somar} className="btn" style={{ color: 'white', backgroundColor: 'gray', margin: '0 25px', fontSize: '18px' }}>Gasto Total:</Link>
