     ...
     <div className="container-fluid">
      ...
      <div className="container" style={{ display: 'flex', margin: '0 230px', marginTop: '-1100px' }}>
        ...
        <div className="px-5 mt-5">
          <div className="mb3">
            <label htmlFor="Nome" className="Nome" style={{ fontFamily: 'arial', fontSize: '17px', fontWeight: 'bold' }}>Busca por Data:</label><br />
            <input type="search" autoFocus='true' className="consultanome form-control rounded-0" value={buscadata} onChange={(e) => setBuscaData(e.target.value)} style={{ fontFamily: 'arial', fontSize: '17px', fontWeight: 'bold', color: 'navy', width: '160px' }} /> <br />
