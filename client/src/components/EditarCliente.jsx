...
const EditarCliente = () => {
  ...
  useEffect(() => {
    fetch("https://sistemacomercial-fv5g.onrender.com/clientes/" + clientecod).then((res) => {
      return res.json();
    }).then((resp) => {
      idchange(resp.id);
    ...
    if (isValidate()) {
      Swal.fire({
        ...
        if (result.isConfirmed) {
          ...
          fetch("https://sistemacomercial-fv5g.onrender.com/clientes/" + clientecod, {
            method: "PUT",
   ...
   <div className="main-wrapper">
      ...
      <div className="container" style={{ display: 'flex', margin: '0 230px', marginTop: '-950px' }}>
        ...
        <form action='' onSubmit={editar}>
          <h5><center><strong>Editar Cliente:</strong></center></h5><br />
          <div className='mb-3'>
            <label htmlFor='id' style={{ fontSize: '17px', margin: '0 115px', fontWeight: 'bold' }}>Id:</label>
            <input type='number' id="id" value={id} onChange={e => idchange(e.target.value)} style={{ fontSize: '17px', width: 100, margin: '0 115px', fontWeight: 'bold', color: 'navy' }} className='form-control rounded-0' name='id' />
          </div>
          <div className='mb-3'>
            <label htmlFor='nome' style={{ fontSize: '17px', margin: '0 115px', fontWeight: 'bold' }}>Nome:</label>
            <input type='text' onKeyUp={MostraNome} id="nome" placeholder='Entre com o nome:' value={nome} onChange={e => nomechange(e.target.value)} style={{ fontSize: '17px', width: 400, margin: '0 115px', fontWeight: 'bold', color: 'navy' }} className='form-control rounded-0' name='nome' />
          </div>
          <div className='mb-3'>
          ...
          <div className='mb-3'>
            ...
            <input type='text' onKeyUp={MostraTelefone} id="fone" value={fone} onChange={e => fonechange(e.target.value)} style={{ fontSize: '17px', width: 225, margin: '0 115px', fontWeight: 'bold', color: 'navy' }} placeholder='Entre com o telefone:' className='form-control rounded-0' name='fone' />
          </div>
          <div className='mb-3'>
          ...
          <div className='mb-3'>
            ...
            <input type='text' onKeyUp={MostraBairro} id="bairro" placeholder='Entre com o bairro:' value={bairro} onChange={e => bairrochange(e.target.value)} style={{ fontSize: '17px', width: 225, margin: '0 115px', fontWeight: 'bold', color: 'navy' }} className='form-control rounded-0' name='bairro' />
          </div>
          <div className='mb-3'>
            <label htmlFor='cpf' style={{ fontSize: '17px', margin: '0 115px', fontWeight: 'bold' }}>Cpf:</label>
            <input aria-disabled={true} onKeyUp={MostraCpf} type='text' value={cpf} onChange={e => cpfchange(e.target.value)} style={{ fontSize: '17px', width: 225, margin: '0 115px', color: 'navy', fontWeight: 'bold' }} className='form-control rounded-0' name='cpf' id="cpf" />
          </div>
          <div className='mb-3'>
            <button type='submit' className='btn btn-success border rounded-0' style={{ width: 100, margin: '0 115px', fontSize: '15px' }} >Atualizar:</button>
