            ...
            <div className='bg-white p-4 rounded w-50 border'>
              ...
              <form action='' onSubmit={editar}>
                <div className='mb-3'>
                  ...
                  <input type='number' id="id" value={id} onChange={e => idchange(e.target.value)} style={{ fontSize: '20px', width: 100, margin: '0 115px' }} className='form-control rounded-0' name='id' />
                </div>
                <div className='mb-3'>
                  <label htmlFor='nome' style={{ fontSize: '20px', margin: '0 115px' }}>Nome:</label>
                  <input type='text' onKeyUp={MostraNome} id="nome" placeholder='Entre com o nome:' value={nome} onChange={e => nomechange(e.target.value)} style={{ fontSize: '20px', width: 400, margin: '0 115px' }} className='form-control rounded-0' name='nome' />
                </div>
                <div className='mb-3'>
                ...
                <div className='mb-3'>
                  ...
                  <input type='text' onKeyUp={MostraTelefone} id="fone" value={fone} onChange={e => fonechange(e.target.value)} style={{ fontSize: '20px', width: 225, margin: '0 115px' }} placeholder='Entre com o telefone:' className='form-control rounded-0' name='fone' />
                </div>
                <div className='mb-3'>
                ...
                <div className='mb-3'>
                  ...
                  <input type='text' onKeyUp={MostraBairro} id="bairro" placeholder='Entre com o bairro:' value={bairro} onChange={e => bairrochange(e.target.value)} style={{ fontSize: '20px', width: 225, margin: '0 115px' }} className='form-control rounded-0' name='bairro' />
                </div>
                <div className='mb-3'>
                  <label htmlFor='cpf' style={{ fontSize: '20px', margin: '0 115px' }}>Cpf:</label>
                  <input aria-disabled={true} onKeyUp={MostraCpf} type='text' value={cpf} onChange={e => cpfchange(e.target.value)} style={{ fontSize: '20px', width: 225, margin: '0 115px' }} className='form-control rounded-0' name='cpf' id="cpf" />
                </div>
                <div className='mb-3'>
