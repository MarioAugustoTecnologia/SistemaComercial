        ...
        <form action='' onSubmit={editar} style={{ marginTop: '-900px' }}>
          ...
          <div className="mb-3">
           ...
           <div className="mb-3">
            ...
            <input onKeyUp={MudacorCb} type='text' value={cb} onChange={e => cbchange(e.target.value)} style={{ width: 150, margin: '0 115px', fontWeight: 'bold', color: 'navy' }} className='form-control rounded-0' name='cb' id="cb" />
          </div>
          <div className='mb-3'>
