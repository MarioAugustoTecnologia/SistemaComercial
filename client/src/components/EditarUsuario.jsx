            ...
            <div className='bg-white p-4 rounded w-42 border'>
              ...
              <form action='' onSubmit={editar}>
                <div className='mb-3'>
                  ...
                  <input onKeyUp={MostraNome} type='text' value={id} onChange={e => idchange(e.target.value)} style={{ fontSize: '20px', width: 150, margin: '0 115px' }} className='form-control rounded-0' name='id' id="id" />

                </div>
                <div className='mb-3'>
                  <label htmlFor='cod' style={{ fontSize: '20px', margin: '0 115px' }}>Cod:</label>
                  <input type='number' onKeyUp={MostraCod} value={cod} onChange={e => codchange(e.target.value)} style={{ fontSize: '20px', width: 85, margin: '0 115px' }} className='form-control rounded-0' name='cod' id="cod" />
                ...
                <div className='mb-3'>
                  ...
                  <input type='date' value={data_nascimento} onChange={e => data_nascimentochange(e.target.value)} style={{ fontSize: '20px', width: 225, margin: '0 115px' }} className='form-control rounded-0' name='data_nascimento' id="data_nasc" />
