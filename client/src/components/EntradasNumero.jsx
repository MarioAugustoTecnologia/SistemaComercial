...
const EntradasNumero = () => {
    ...
    const isValidate3 = () => {
        ...
        if (document.getElementById("td").value === null || document.getElementById("td").value === '') {
    ...
    function TotFrete() {
        ...
        if (isValidate3()) {
            ...
            if (document.getElementById("td").value === '') {
                ...
                console.log(total);
                console.log(frete);
                const totfrete = parseFloat(total) + parseFloat(frete);
                console.log(totfrete);

                document.getElementById('totfrete').value = totfrete.toFixed(2);
                document.getElementById('totalcfrete').innerHTML = "R$" + totfrete.toFixed(2)
                document.getElementById('vp').value = totfrete.toFixed(2);


            } else {


                let totaldesc = document.getElementById('td').value;
                let frete = document.getElementById('frete').value;
                console.log(totaldesc);
                console.log(frete);
                const totfrete = parseFloat(totaldesc) + parseFloat(frete);
                console.log(totfrete);
    ...
    function desconto() {
        ...
        if (document.getElementById('desconto').value !== "") {
            ...
            document.getElementById('td').innerHTML = "R$" + novototal.toFixed(2)
            ...
            table.map(item => {
                valores.push(item.totaldesc)
            })
            const soma = valores.reduce((previous_value, current_value) => {       // método que faz a soma
                return parseFloat(previous_value) + parseFloat(current_value);     // converte de string para number
            })

            document.getElementById('td').value = (soma).toFixed(2);
            document.getElementById('totald').innerHTML = "R$" + soma.toFixed(2)
            document.getElementById('vp').value = (soma).toFixed(2);
    ...
    function Troco() {
        ...
        if (document.getElementById('vp').value === "" || document.getElementById('vp').value === null) {
            ...
            const totaldesc = document.getElementById('td').value;
            console.log(vp);
            console.log(total);
            console.log(tf);
            console.log(totaldesc)
            ...
            if (tf === '') {
                ...
                if (totaldesc !== '') {
                    ...
                    const troco = parseFloat(vp) - parseFloat(totaldesc);
                    console.log(troco);
                    ...
                    const troco = parseFloat(vp) - parseFloat(total);
                    console.log(troco);
                    document.getElementById('troco').value = troco.toFixed(2)
                    MudaCorTroco()
                ...
                const troco = parseFloat(vp) - parseFloat(tf);
                console.log(troco);
                document.getElementById('troco').value = troco.toFixed(2)
                MudaCorTroco()
    ...
    const concluir = (e) => {
        ...
        if (isValidate()) {
            ...
            if (parcelamento === "" || parcelamento === null && parcelan === "" || parcelan === null) {
                    ...
                    if (document.getElementById('frete').value === "" || document.getElementById('frete').value === null) {
                        ...
                        if (Number(valorpagto) > Number(total)) {//ok
                            ...
                            if (troco !== "") {
                                ...
                                const cadobj = { vendan, total, nome, valorpagto, mes, formapag, troco, data_cad }
                        ...
                        if (Number(valorpagto) > Number(totfrete)) {//ok
                            ...
                            if (troco !== "") {
                                ...
                                const cadobj = { vendan, total, nome, valorpagto, mes, formapag, troco, data_cad, frete, totfrete }
                ...
                //3. TOTAL COM DESCONTO NÃO GERAL ...
                if (document.getElementById('desconto').value == "" && document.getElementById('td').value !== '' && document.getElementById('vd').value == '') {
                    ...
                    if (document.getElementById('frete').value === "" || document.getElementById('frete').value === null) {
                        ...
                        if (Number(valorpagto) > Number(totaldesc)) {//ok
                            ...
                            if (troco !== "") {
                                ...
                                const cadobj = { vendan, total, nome, valorpagto, mes, formapag, troco, data_cad, totaldesc }
                            ...
                            if (Number(valorpagto) === Number(totaldesc)) {//ok
                                ...
                                const cadobj = { vendan, total, nome, valorpagto, mes, formapag, data_cad, totaldesc }
                        ...
                        const frete = parseFloat(document.getElementById('frete').value).toFixed(2);
                        const totfrete = parseFloat(document.getElementById('totfrete').value).toFixed(2)
                        const totaldesc = parseFloat(document.getElementById('td').value)
                        ...
                        if (Number(valorpagto) > Number(totfrete)) {//ok
                            ...
                            if (troco !== "") {
                                ...
                                const cadobj = { vendan, total, nome, valorpagto, mes, formapag, troco, data_cad, frete, totfrete, totaldesc}
                            ...
                            if (Number(valorpagto) === Number(totfrete)) {//ok
                                ...
                                const cadobj = { vendan, total, nome, valorpagto, mes, formapag, data_cad, frete, totfrete, totaldesc }
            ...
            <div className="container" style={{ display: 'flex', margin: '0 130px' }}>
                ...
                <form action='' style={{ marginTop: '-950px' }} onSubmit={concluir}>
                    <div className="mb3" style={{ margin: '0 100px' }}>
                        <label htmlFor="Numero" className="Numero" style={{ fontFamily: 'arial', fontWeight: 'bold' }}>Buscar Venda nº:</label>
                        <label htmlFor="compraatual" hidden="true" className="vendaatual" style={{ fontFamily: 'arial', fontSize: '17px', fontWeight: 'bold', margin: '0 15px' }}>Venda Atual:</label>
                            ...
                            <tbody>
                                {
                                    entradadata.map(item => (
                                        <tr key={item.id}>
                                            ...
                                            <td className="td" hidden='true' style={{ color: 'blue', fontSize: '18px', margin: '0 120px' }} id="vendn">{item.numero}</td>
                        ...
                        <div className="d-flex" style={{ marginTop: '-23px' }}>
                            ...
                            <strong style={{ margin: '0 100px', fontSize: '30px' }}>Total c/ Frete:</strong>
                            <strong><span id="totalcfrete" style={{ color: 'SlateBlue', margin: '0 -90px', fontSize: '30px' }}></span></strong>
                    ...
                    <div className="bg-white p-4 rounded border-none" style={{ margin: '0 100px', marginTop: '-60px' }}>
                        ...
                        <input onKeyDown={MudaCorTroco} type="decimal" className="form-control rounded-0" style={{ width: '6%', height: '42px', margin: '0 340px', marginTop: '-42px', fontWeight: 'bold', color: 'navy', fontSize: '19px' }} id="troco" />
                        <br />
                        ...
                        <div className="d-flex">
                            <select className="form-control rounded-0" value={parcelamento} onChange={e => parcelamentochange(e.target.value)} style={{ width: '10%', height: '42px', fontSize: '20px', fontWeight: 'bold', color: 'navy' }} onSelect={MudaCorParcelamento} id="parcelamento" >
                                <option value=""></option>
                        ...
                        <label htmlFor="frete" style={{ fontFamily: 'arial', margin: '0 150px', fontWeight: 'bold' }} >Frete:</label>
                        <label htmlFor="totfrete" style={{ fontFamily: 'arial', fontWeight: 'bold', margin: '0 -40px' }} >Total c/ Frete:</label>
                        ...
                        <input type="decimal" className="form-control rounded-0" style={{ width: 120, margin: '0 180px', marginTop: '-40px', fontWeight: 'bold', color: 'navy', fontSize: '19px' }} onKeyDown={MudaCorFrete} id="frete" /><br />
                        <input type="decimal" className="form-control rounded-0" style={{ width: 120, margin: '0 345px', marginTop: '-70px', fontWeight: 'bold', color: 'navy', fontSize: '19px' }} id="totfrete" /> <br />
                        <div className="d-flex">
                        ...
                        <tbody>
                            {
                                table.map(item => (
                                    <tr key={item.id}>
                                        ...
                                        <td className="td">{item.totfrete}</td>
