...
const FornecedorCat = () => { 
  ...
  const buscarap = buscacat.toLowerCase() 
  
  var table = fornecedor.filter(item => item.catforn.toLowerCase().includes(buscarap))
  ...
  return (
     <div className="container-fluid">
          ...
          <div className="container" style={{ display: 'flex', margin: '0 230px', marginTop: '-960px' }}>
            ...
            <div className="mb3">
              <label htmlFor="Nome" className="Nome" style={{ fontFamily: 'arial', fontSize: '17px', fontWeight: 'bold' }}>Busca por Categoria:</label><br />
              <input style={{ fontFamily: 'arial', fontSize: '17px', fontWeight: 'bold', color: 'navy', padding: '2px', width: '200px' }} type="search" autoFocus='true' className="form-control rounded-0" value={buscacat} onChange={(e) => setBuscaCat(e.target.value)} />
