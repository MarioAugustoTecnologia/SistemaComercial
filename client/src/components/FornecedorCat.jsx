      ...
      <div className="row flex-nowrap">
        ...
        <div className="col p-0 m-0">
          ...
          <div className="px-5 mt-5">
            <div>
              <label htmlFor="Categoria" className="Categoria" style={{ fontFamily: 'arial', fontSize: '22px' }}>Busca por categoria:</label><br />
              <input style={{ fontFamily: 'arial', fontSize: '22px' }} type="search" autoFocus='true' className="consultacategoria" value={buscacat} onChange={(e) => setBuscaCat(e.target.value)} />
