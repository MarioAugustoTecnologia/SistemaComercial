        ...
        <div className="col p-0 m-0">
          ...
          <div className="px-5 mt-5">
            <div>
              ...
              <input style={{ fontFamily: 'arial', fontSize: '22px', fontWeight: 'bold', color: 'navy', width: '300px', padding: '2px' }} type="search" autoFocus='true' className="form-control rounded-0" value={buscanome} onChange={(e) => setBuscaNome(e.target.value)} />
              <Link to="/fornecedores" className="btn" style={{ color: 'white', backgroundColor: 'orange', margin: '0 350px', fontSize: '18px', fontFamily: 'arial', width: '140px', marginTop: '-60px' }}>Voltar:</Link>
