...
const handleDelete = (id) => {    
  ...
  fetch("https://sistemacomercial-fv5g.onrender.com/mescompraatual/" + id , {
              ...
              <tbody>
                {
                  mescompraatual.map(item => (
                    <tr key={item.id}>
                      ...
                      <td className="td" style={{ color: 'blue', fontSize: '25px' }}><strong>{item.mes}</strong></td>
                      <td className="td"><button className="excluir" onClick={() => { handleDelete(item.id) }} style={{ color: 'white', backgroundColor: 'red', border: 'none', borderRadius: '5px', fontSize: '17px', marginTop: '25px' }}>Excluir:</button></td>
                      <td className="td"><button className="voltar" onClick={Return} style={{ color: 'white', backgroundColor: 'orange', border: 'none', borderRadius: '5px', fontSize: '17px', marginTop: '25px' }}>Voltar:</button></td>
                    </tr>
                  ))
