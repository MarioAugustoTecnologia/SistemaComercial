...
const ProdutoCatEditar = () => {
  ...
  useEffect(() => {
    fetch("https://sistemacomercialserver.onrender.com/catproduto/" + catcod).then((res) => {
      return res.json();
    }).then((resp) => {
    ...
    if(isValidate()){
      ...
      Swal.fire({
                          ...
                          if (result.isConfirmed) {
                            ...
                            fetch("https://sistemacomercialserver.onrender.com/catproduto/" + catcod, {
                              method: "PUT",
    ...
    <div className="container-fluid" style={{fontFamily:'arial'}}>
       <div className="row flex-nowrap">
          ...
          <div className='bg-white p-4 rounded w-30 border'>
             <h4><center><strong>Editar Categoria:</strong></center></h4><br /> 
            <form action='' onSubmit={editar}>
                 <div className='mb-3'>      
                    <label htmlFor='nome' style={{fontSize:'20px', margin:'0 115px', fontWeight:'bold'}}>Nome:</label>
                    <input type='text' placeholder='Entre com o nome:' value={nome} onChange={e => nomechange(e.target.value)} style={{fontSize:'20px', width:250, margin:'0 115px', fontWeight:'bold', color:'navy'}} className='form-control rounded-0' name='nome'/>
                 </div>
                 <div className='mb-3'>
                 ...
                 <Link to='/produtos/categoria/lista' className="btn border rounded-0" style={{color: 'white', backgroundColor:'orange', margin: '0 -90px', fontSize:'16px', width:100}}>Voltar:</Link>
              </div> 
             <ToastContainer />                
         </form>
       </div>  
...
export default ProdutoCatEditar