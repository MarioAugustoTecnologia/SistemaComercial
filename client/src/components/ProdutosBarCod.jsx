    ...
    <div className="container-fluid">
      ...
      <div className="container" style={{ display: 'flex', margin: '0 230px', marginTop: '-850px' }}>
        ...
        <div className="mb3" style={{ marginTop: '-50px' }}>
          ...
          <input style={{ fontFamily: 'arial', fontSize: '17px', width: '140px', color: 'navy', fontWeight: 'bold' }} type="search" className="form-control rounded-0" value={buscarap} onChange={(e) => setBuscaRap(e.target.value)} id="busca" autoFocus='true' />
