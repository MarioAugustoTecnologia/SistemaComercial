...
const UsuarioNome = () => { 
  ...
  var table = usuariodata.filter(item => item.id.toLowerCase().includes(buscarap))
       ...
       <div className="col p-0 m-0">
           ...
           <div className="px-5 mt-5">                  
                <div id="conteudo">
                  ...
                  <label htmlFor="Nome" className="Nome" >Busca por nome:</label><br />
                  <input className="consultanome" type="search" value={buscanome} onChange={(e) => setBuscaNome(e.target.value)} />
